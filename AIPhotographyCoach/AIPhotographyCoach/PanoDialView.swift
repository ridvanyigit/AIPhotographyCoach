...
// MARK: - Apple Pano Mod Seçim Çarkı (1:1 Direksiyon Kavis Fiziği)
struct PanoDialView: View {
    ...
    var body: some View {
        VStack(spacing: 4) {
            // 1. CANLI GÜNCELLENEN PANO BAŞLIĞI
                    ...
                    ZStack {
                        Circle()
                            ...
                            .overlay(
                                Circle()
                                    .stroke(
                                        isFocused ? Color.yellow : Color.white.opacity(0.25),
