...
struct PortraitLightingDialView: View {
    ...
    private var allModes: [PortraitLightingMode] { PortraitLightingMode.allCases }
        ...
        VStack(spacing: 8) {
            ...
            ZStack {
                ForEach(0..<allModes.count, id: \.self) { i in
                    ...
                    ZStack {
                        Circle()
                            .fill(Color.white.opacity(0.05)) // %5 Şeffaf İç Dolgu
                            .frame(width: 38, height: 38)   // Çapı 38'e küçültüldü
                            .overlay(
                                Circle()
                                    .stroke(
